...
def test_build_report2_excel_outputs_workbook() -> None:
    ...
    assert sheet.page_margins.top == 1 / 2.54
    assert sheet.page_margins.bottom == 1 / 2.54
    assert sheet.page_margins.left == 0.3 / 2.54
    assert sheet.page_margins.right == 0.3 / 2.54
    assert sheet.page_margins.header == 1.9 / 2.54
    assert sheet.page_margins.footer == 0.6 / 2.54
