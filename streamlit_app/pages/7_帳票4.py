...
if not df.empty:
    ...
    pivot = df.pivot_table(
        index=["Rpt1ClinDeptID", "Rpt4ClinDeptID", "ClinDeptName", "DoctorID", "DoctorName"],
    ...
    pivot = pivot.drop(columns=["Rpt1ClinDeptID", "Rpt4ClinDeptID", "DoctorID"])
    ...
    numeric_cols = [col for col in pivot.columns if col not in ["診療科名", "DoctorName"]]
