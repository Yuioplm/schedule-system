...
def build_report2_excel(df_with_diff: pd.DataFrame, output_mode_label: str) -> bytes:
    ...
    for column_letter, pixels in COLUMN_WIDTH_PIXELS.items():
        ws.column_dimensions[column_letter].width = excel_width_from_pixels(pixels)
